<%-- 
    Document   : menu
    Created on : 29-09-2019, 22:07:21
    Author     : Asus
--%>
...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image: url('img/empanadas-tamano-xl-grandes-x-doc-al-horno-y-soufle-sabor-D_NQ_NP_531511-MLA20558840704_012016-F.jpg');">
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-8 text-center col-sm-12 element-animate">
              <h1>cosina a la chilena</h1>
              <p class="mb-5">En la empanada chilena, 
el sabor es un tesoro, 
y como no lo va a ser, 
si se cocina con oro</p>
              <p><a href="#" class="btn btn-white btn-outline-white">Get Started</a></p>
            </div>
          </div>
        </div>
